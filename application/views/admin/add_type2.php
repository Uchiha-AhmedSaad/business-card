				...
				<div class="col-xs-12 ">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>         أضافة نوع معدات ثقيلة
							</div>
							...
							<form role="form" method="post" action=""  enctype="multipart/form-data">
								<div class="form-body">
									<div class="form-group">
										...
										<input type="text" name="type2_name" class="form-control" id="exampleInputEmail1" placeholder="Enter text">
