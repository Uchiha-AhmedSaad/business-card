				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>  	  الاعلانات المحذوفة
							</div>
						...
						<div class="portlet-body">
                         ...
                         $q1= $ci->city_m->find_all_where('city_id',$result->ads_city); 
                         $d1= $q1->row();
                    
                         ?> 
                          <a target="_blank" href="<?php echo base_url(); ?>site/city/<?php echo $d1->city_id; ?>"><?php echo $d1->city_name; ?></a>
								</td>
						...
						<?php }else{} ?>
								...
								<td>
									 <a class="btn default btn-xs purple" href="<?php echo base_url(); ?>admin/do_act_ads/<?php echo $result->ads_id; ?>" onclick="return confirm('هل تريد بالفعل تنفيذ الأمر ؟');"><i class="fa fa-edit"></i> تفعيل</a>
								</td>
