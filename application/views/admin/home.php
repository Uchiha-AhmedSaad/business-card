	...
	<i class="fa fa-user" aria-hidden="true"></i>
						...
						<div class="details">
							<div class="number">
							 	<?php
                                    $ci->load->model('ads_m');
                                    echo $ci->ads_m->count_all_where('ads_active',1);
                                    ?>
							</div>
							<div class="desc">
						...
						<a class="more" href="<?php echo base_url(); ?>admin/edit_ads1">
							عرض الكل <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
                ...
                <br />
								...
								<td>
								 5- عدد رسائل اتصل بنا
                                    ...
                                    ?>
                                                                          ...
                                                                          <tr>
								<td>
							     6- عدد الاعلانات الغير مفعلة
								</td>
								<td>
                                       	<?php
                                    $ci->load->model('ads_m');
                                    $c= $ci->ads_m->queryy("select * from ads where ads_active=0");
                                    echo $c->num_rows();
                                    ?>
								</td>
                                 ...
                                 <tr>
								<td>
							     7- عدد الاعلانات المفعلة
								</td>
								<td>
                                   	<?php
                                    $ci->load->model('ads_m');
                                    $c= $ci->ads_m->queryy("select * from ads where ads_active=1");
                                    echo $c->num_rows();
                                    ?>
								</td>
                                  ...
                                  <tr>
								<td>
							    8-  عدد الاعلانات المحذوفة
								</td>
								<td>
                                   	<?php
                                    $ci->load->model('ads_m');
                                    $c= $ci->ads_m->queryy("select * from ads where ads_active=2");
                                    echo $c->num_rows();
                                    ?>
								</td>
                                  ...
                                  <tr>
								<td>
							     9- عدد الاعلانات المحظورة
								</td>
								<td>
                                   	<?php
                                    $ci->load->model('ads_m');
                                    $c= $ci->ads_m->queryy("select * from ads where ads_active=3");
                                    echo $c->num_rows();
                                    ?>
								</td>
							...
							<tr>
								...
								<td>
                                       	<?php
                                    $ci->load->model('save_ads_m');
                                    $c= $ci->save_ads_m->queryy("select * from save_ads");
                                    echo $c->num_rows();
                                    ?>
								</td>
