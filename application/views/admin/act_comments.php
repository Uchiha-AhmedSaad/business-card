				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>		التعليقات المفعلة
							</div>
							...
							<tbody>
                             ...
                             <tr>
                                ...
                                <td>
                              	...
                              	<td>
									 <a class="btn default btn-xs black" href="<?php echo base_url(); ?>admin/do_edit_comments/<?php echo $result->comment_id; ?>" onclick="return confirm('هل تريد بالفعل تنفيذ الأمر ؟');"><i class="fa fa-trash-o"></i> تعديل</a>
								</td>  
