                  ...
                  <form role="form" method="post" action="">
                     ...
                     <div class="form-body">
                        <div class="form-group">
                           ...
                           <input type="text" name="city_name" class="form-control" id="city_name" placeholder="Enter text">
                        </div>
                        <div class="form-group">
                           <label for="city_name_en">اسم المدينة  بالإنجليزية :</label>
                           <input type="text" name="city_name_en" class="form-control" id="city_name_en" placeholder="Enter text">
                        </div>
                        <div class="form-group">
                           <label for="city_country">الدولة  :</label>
                           <select class="form-control" name="city_country" id="city_country">
                              <?php
