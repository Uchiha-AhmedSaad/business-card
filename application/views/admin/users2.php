				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i> 		 الاعضاء المحظورين
							</div>
							...
							<tbody>
                             ...
                             <tr>
								...
								<td>
                                	...
                                	<td>
									 <a class="btn default btn-xs purple" href="<?php echo base_url(); ?>admin/do_dis_users/<?php echo $result->user_id ; ?>" onclick="return confirm('هل تريد بالفعل تنفيذ الأمر ؟');"><i class="fa fa-edit"></i>  الغاء </a>
								</td>
