				...
				<div class="col-xs-12 ">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> تعديل مدينة
							</div>
							...
							<form role="form" method="post" action="">
                              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();  ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                           	...
                           	<div class="form-group">
                                        ...
                                        ?>
                                        <option <?php if($d->country_id==$city_country) echo "selected"; ?> value="<?php echo $d->country_id; ?>"><?php echo $d->country_name; ?></option>
                                        <?php } ?>
                                        </select>
									</div>
									...
									<div class="form-group">
										...
										<input type="number" value="<?php echo $city_order; ?>" name="city_order" class="form-control" id="exampleInputEmail1" placeholder="Enter text">
