				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i>   طلبات تميز الكروت الجديدة
							</div>
						...
						<div class="portlet-body">
							...
							foreach ($card_package_requests as $card) 
							{
								...
								?> 
									<tr>
										...
										<td><a class="btn btn-success" href="<?php echo base_url('admin/packageRequest/'.$card->request_id.'/accept'); ?>">الموافقة</a></td>
