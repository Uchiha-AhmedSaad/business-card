				...
				<div class="col-xs-12 ">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> أضافة منطقة
							</div>
                              ...
                              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();  ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
								<div class="form-body">
									<div class="form-group">
										...
										<input type="text" name="adress_name" class="form-control" id="exampleInputEmail1" placeholder="Enter text">
										...
										<select class="form-control" name="adress_country">
                                        <?php
                                        $ci->load->model('country_m');
                                        $q_city= $ci->country_m->find_all_desc('country_id');
                                        foreach($q_city as $d){
                                        ?>
