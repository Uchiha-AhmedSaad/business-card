		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12 ">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>   تعديل  الرقم السرى
							</div>
         	...
         	<div class="form-group">
										...
										<input type="password" value="<?php echo $user_pass; ?>" name="user_pass" class="form-control" id="exampleInputEmail1" placeholder="Enter text">
