				...
				<div class="col-xs-12 ">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> تعديل سؤال
							</div>
                              ...
                              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();  ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
															<div class="form-body">
																<div class="form-group">
																	...
																	<input type="text" name="faq_title" class="form-control" id="exampleInputEmail1" value="<?php echo $faq_title; ?>" placeholder="Enter text">

																</div>
																<div class="form-group">
																	<label for="exampleInputEmail1">عنوان السؤال بالانجليزية :</label>
																	<input type="text" name="faq_title_en" class="form-control" id="exampleInputEmail1" value="<?php echo $faq_title_en; ?>" placeholder="Enter text">
